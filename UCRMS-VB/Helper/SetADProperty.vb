...
#End Region
        Public Shared Function GetDirectoryEntry() As DirectoryEntry
            ...
            dirEntry.Path = "LDAP://10.10.100.254/CN=Users;DC=Yourdomain"
            dirEntry.Username = "umt\app.software"
            dirEntry.Password = "c6d4&1bt^vNk@L01#FbR$n4fu"
            Return dirEntry
        End Function
        ...
        Public Shared Function GetUsersinGroup(ByVal GroupName As String) As DataSet
            ...
            If Not searchResults Is Nothing Then
                ...
                Dim propCollection As DirectoryServices.PropertyCollection = dirGroup.Properties
